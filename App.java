...
//		String tsuPdfFiles = "https://www.google.com/search?q=tsu.ge&as_filetype=pdf&as_sitesearch=tsu.ge&as_qdr=y&num=100";
		...
		String searchPhrase = "yellow car";
		System.setProperty("webdriver.edge.driver", "msedgedriver.exe");

		WebDriver driver = new EdgeDriver();
		driver.navigate().to("http://www.google.com/search?tbm=isch&as_oq=" + searchPhrase);
		...
		Pattern pattern = Pattern.compile("https?:\\/\\/(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&//=]*)(?=png|jpg|gif)\\w+");
		...
		for (Element script : scripts) {
			...
			while (matcher.find()) {
				...
				results.add(URLDecoder.decode(matcher.group(), Charset.forName("UTF-8")));
			}
